...
const eventswithusersAPI_auto = {

    /** Gets all entries from 'eventswithusers' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/eventswithusers`, requestOptions);
        return response.data;
    },
};

export { eventswithusersAPI_auto };