...
const photoswithtagsAPI_auto = {

    /** Gets all entries from 'photoswithtags' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/photoswithtags`, requestOptions);
        return response.data;
    },
};

export { photoswithtagsAPI_auto };